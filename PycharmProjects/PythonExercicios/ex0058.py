...
cpu = randint(0, 10)
palpite = '' #acerto = False
tentativa = 0
while palpite != cpu: #palpite == cpu -> acerto = True
    ...
    if palpite < 0 or palpite > 10:
        ...
        tentativa += 1
        if palpite > cpu:
            print(f'Menos... Essa é foi sua {tentativa}ª tentativa!')
        elif palpite < cpu:
            print(f'Mais... Essa foi sua {tentativa}ª tentativa!')
print('')
print('-'*60)
if tentativa == 1:
